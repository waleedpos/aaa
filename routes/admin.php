...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['auth','admin']], function (){
	...
	Route::get('/add-customer', 				[ADMIN\AdminController::class, 'addCustomer'])->name('admin.add-customer');
	Route::post('/add-customer', 				[ADMIN\AdminController::class, 'saveCustomer'])->name('admin.save-customer');
